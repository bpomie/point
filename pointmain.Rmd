...
* $bin1$     --  difference scores in time bin 1
* $bin2$     --  difference scores in time bin 2
* $bin3$     --  difference scores in time bin 3
* $bin4$     --  difference scores in time bin 4
* $bin5$     --  difference scores in time bin 4
...
dflong <- df %>% 
  gather(key="Time", value="DiffScore",
...
e1plot$Time <- factor(e1plot$Time, 
                       levels = c("bin1","bin2","bin3", "bin4", "bin5"))
...
```{r}
t.test(DiffScore ~ Condition, data = e1data %>% filter(Time=="bin1"), paired = TRUE)
cohensD(DiffScore ~ Condition, data = e1data %>% filter(Time=="bin1"), method = "paired")
```
...
```{r}
# 1-2 s
t.test(DiffScore ~ Condition, data = e1data %>% filter(Time=="bin2"), paired = TRUE)
# 2-3 s
t.test(DiffScore ~ Condition, data = e1data %>% filter(Time=="bin3"), paired = TRUE)
# 3-4 s
t.test(DiffScore ~ Condition, data = e1data %>% filter(Time=="bin4"), paired = TRUE)
# 4-5 s
t.test(DiffScore ~ Condition, data = e1data %>% filter(Time=="bin5"), paired = TRUE)
```
...
e2_plot$Time <- factor(e2_plot$Time,
                       levels = c("bin1","bin2",
                                  "bin3", "bin4", "bin5"))
...
##### Box plots
```{r}
b2 <- ggplot(data = e2_plot, aes(x=Time, y=DiffScore)) +
  theme_light() +
          theme(strip.text = element_text(size = 14),
                panel.grid.major.y = element_line(colour="gray75"),
                panel.grid.major.x = element_blank(),
...
```{r }
#Trained condition
t.test(e2datatimeave$avedf[e2datatimeave$Condition == "Trained"], mu = 0, alternative = "two.sided")
cohensD(e2datatimeave$avedf[e2datatimeave$Condition == "Trained"], mu = 0)

#Novel condition
t.test(e2datatimeave$avedf[e2datatimeave$Condition == "Novel"], mu = 0, alternative = "two.sided")
cohensD(e2datatimeave$avedf[e2datatimeave$Condition == "Novel"], mu = 0)
```
...
ae1e2b1 <- aov_car((DiffScore ~ Condition*Experiment 
                + Error(Subject/Condition) + Experiment), data = e1e2anova%>%filter(Time == "bin1"))
...
ae1e2b2 <- aov_car((DiffScore ~ Condition*Experiment + Error(Subject/Condition) + Experiment),
                   data = e1e2anova%>%filter(Time == "bin2"))
...
ae1e2b3 <- aov_car((DiffScore ~ Condition*Experiment + Error(Subject/Condition) + Experiment),
                   data = e1e2anova%>%filter(Time == "bin3"))
...
ae1e2b4 <- aov_car((DiffScore ~ Condition*Experiment + Error(Subject/Condition) + Experiment),
                   data = e1e2anova%>%filter(Time == "bin4"))
...
e3plot$Time <- factor(e3plot$Time, 
                       levels = c("bin1","bin2","bin3", "bin4", "bin5"),
                       labels = c("Test bin 1","Test bin 2", "Test bin 3", "Test bin 4", "Test bin 5"))
...
e4plot$Time <- factor(e4plot$Time, 
                       levels = c("bin1","bin2",
                                  "bin3", "bin4", "bin5"),
                       labels = c("Test bin 1","Test bin 2", "Test bin 3", "Test bin 4",
                                  "Test bin 5"))
...
```{r }
#Trained condition
t.test(e4datatimeave$avedf[e4datatimeave$Condition == "Trained"], mu = 0, alternative = "two.sided")
cohensD(e4datatimeave$avedf[e4datatimeave$Condition == "Trained"], mu = 0)

#Novel condition
wt <- wilcox.test(e4datatimeave$avedf[e4datatimeave$Condition == "Novel"],
                  mu = 0, alternative = "two.sided",conf.int = TRUE, conf.level = 0.95)
Zstat<-qnorm(wt$p.value)
wt
Zstat
...
e4datatimeave %>%
  ...
  wilcox_effsize(avedf~1, mu = 0)

t.test(e4datatimeave$avedf[e4datatimeave$Condition == "Novel"], mu = 0, alternative = "two.sided")
cohensD(e4datatimeave$avedf[e4datatimeave$Condition == "Novel"], mu = 0)
```
...
```{r }
t.test(DiffScore ~ Condition, data = e4data %>% filter(Time == "bin1"), paired = TRUE)
cohensD(DiffScore ~ Condition, data = e4data %>% filter(Time == "bin1"), method = "paired")
```

```{r }
t.test(DiffScore ~ Condition, data = e4data %>% filter(Time == "bin2"), paired = TRUE)
cohensD(DiffScore ~ Condition, data = e4data %>% filter(Time == "bin2"), method = "paired")
```

```{r }
t.test(DiffScore ~ Condition, data = e4data %>% filter(Time == "bin3"), paired = TRUE)
cohensD(DiffScore ~ Condition, data = e4data %>% filter(Time == "bin3"), method = "paired")
```
...
```{r }
# 
e4_data_trained <- subset(e4data, Condition == "Trained")
e4_data_novel <- subset(e4data, Condition == "Novel")
```

```{r }
t.test(e4_data_trained$DiffScore[e4_data_trained$Time == "bin1"], mu = 0, alternative = "two.sided")
cohensD(e4_data_trained$DiffScore[e4_data_trained$Time == "bin1"], mu = 0)
t.test(e4_data_novel$DiffScore[e4_data_novel$Time == "bin1"], mu = 0, alternative = "two.sided")
cohensD(e4_data_novel$DiffScore[e4_data_novel$Time == "bin1"], mu = 0)
```

```{r }
# Bin 2: 1-2 s
t.test(e4_data_trained$DiffScore[e4_data_trained$Time == "bin2"], mu = 0, alternative = "two.sided")
cohensD(e4_data_trained$DiffScore[e4_data_trained$Time == "bin2"], mu = 0)
t.test(e4_data_novel$DiffScore[e4_data_novel$Time == "bin2"], mu = 0, alternative = "two.sided")
cohensD(e4_data_novel$DiffScore[e4_data_novel$Time == "bin2"], mu = 0)
```
